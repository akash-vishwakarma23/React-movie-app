...
const PersonDetails = () => {
    ...
    return info ? (
        <div className="px-[10%] w-screen h-fit bg-[#1F1E24] ">
            {/* Part 1 navigation */}
            ...
            <div className="w-full flex ">
                ...
                <div className="w-[80%] ml-[5%]">
                    ...
                    <div className="list-disc text-zinc-400 w-full h-[50vh] mt-5 mb-5 overflow-x-hidden overflow-y-auto shadow-xl shadow-[rgba(255,255,255,.3)] border-2 border-zinc-700 p-5">
